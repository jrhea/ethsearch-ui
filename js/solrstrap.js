...
var SERVERROOT = 'https://ethsear.ch:8984/solr/nutch/select/'; //SELECT endpoint
var HITTITLE = 'url';                                        //Name of the title field- the heading of each hit
var HITBODY = 'title';                                          //Name of the body field- the teaser text of each hit
var HITSPERPAGE = 20;                                          //page size- hits per page
var FACETS = [];
var FACETS_TITLES = {'title': 'subjects'};  // selective rename facet names for display

var HITID = 'id'		// Name of the id field
var HITTEASER = 'content';	// Name of field to use for teaser
...
//when the page is loaded- do this
  $(document).ready(function() {
    ...
    var q = getURLParam('q');
    $('#solrstrap-searchbox').attr('value', q);
